...
echo 'Aplikace guide.me slouží k navigování jejího uživatele z počátečního na místové místo v budově.';
echo '<br />';
echo 'Je vybrána vždy taková možná cesta, která uživatele navede vždy za nejkratší možný čas k cíli.';
echo '<br /><br />';

echo 'K navigaci si uživatel bude moci stáhnout virtuální reprezentaci budovy,';
echo '<br />';
