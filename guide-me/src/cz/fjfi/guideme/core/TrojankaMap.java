...
*/
	public static GMMap Trojanka(UUID guid1, UUID guid2)
	{
		...
		GMNode r01 	= new GMNode(guid1, "Záchod 1. patro vzadu", loclist, l01.getDescription(), myMap);
		GMNode s01 	= new GMNode(Utility.generateGUID(), "Zadní schodištì první patro", loclist, l01.getDescription(), myMap);
		GMNode l01l03 	= new GMNode(Utility.generateGUID(), "Zadní dveøe katedra matematiky", loclist, "pøechod mezi " + l01.getDescription() + " a " + l03.getDescription(), myMap);
		GMNode r02 	= new GMNode(Utility.generateGUID(), "T-116", loclist, l02.getDescription(), myMap);
		GMNode r03 	= new GMNode(Utility.generateGUID(), "T-115", loclist, l02.getDescription(), myMap);
		GMNode r04 	= new GMNode(Utility.generateGUID(), "T-115b", loclist, l02.getDescription(), myMap);
		GMNode l02l03 	= new GMNode(Utility.generateGUID(), "Køižovatka severní a hlavní chodby katedry matematiky", loclist, "pøechod mezi " + l02.getDescription() + " a " + l03.getDescription(), myMap);
		GMNode r05 	= new GMNode(Utility.generateGUID(), "T-112", loclist, l03.getDescription(), myMap);
		GMNode r06 	= new GMNode(Utility.generateGUID(), "T-111", loclist, l03.getDescription(), myMap);
		GMNode r07 	= new GMNode(Utility.generateGUID(), "T-110", loclist, l03.getDescription(), myMap);
		GMNode r08 	= new GMNode(Utility.generateGUID(), "T-109", loclist, l03.getDescription(), myMap);
		GMNode r09 	= new GMNode(guid2, "T-108", loclist, l03.getDescription(), myMap);
		GMNode r10 	= new GMNode(Utility.generateGUID(), "T-107<", loclist, l03.getDescription(), myMap);
		GMNode r11 	= new GMNode(Utility.generateGUID(), "T-106", loclist, l03.getDescription(), myMap); 
		GMNode l03l04 	= new GMNode(Utility.generateGUID(), "Pøechod mezi jižní a hlavní chodbbou KM", loclist, "pøechod mezi " + l03.getDescription() + " a " + l04.getDescription(), myMap);
		GMNode r12 	= new GMNode(Utility.generateGUID(), "T-105", loclist, l04.getDescription(), myMap);
		GMNode r13 	= new GMNode(Utility.generateGUID(), "T-104", loclist, l04.getDescription(), myMap);
		GMNode l04l05 	= new GMNode(Utility.generateGUID(), "Vstup na KM", loclist, "pøechod mezi " + l04.getDescription() + " a " + l05.getDescription(), myMap);
		GMNode l05l08 	= new GMNode(Utility.generateGUID(), "Pøechod mezi západní chodbou u vrátnice a severní chodbou u vrátnice", loclist, "pøechod mezi " + l05.getDescription() + " a " + l08.getDescription(), myMap);
		GMNode r14 	= new GMNode(Utility.generateGUID(), "Hlavní vchod do budovy", loclist, l06.getDescription(), myMap);
		GMNode l06l08 	= new GMNode(Utility.generateGUID(), "Pøechod mezi vrátnicí a severní chodbou u vrátnice", loclist, "pøechod mezi " + l06.getDescription() + " a " + l08.getDescription(), myMap);
		GMNode r16 	= new GMNode(Utility.generateGUID(), "Falešný vstup na kluèièí záchody u vrátnice", loclist, l07.getDescription(), myMap);
		GMNode r17 	= new GMNode(Utility.generateGUID(), "Vstup na mužské WC u vrátnice", loclist, l07.getDescription(), myMap);
		GMNode l07l08 	= new GMNode(Utility.generateGUID(), "Pøechod mezi východní chodbou u vrátnice a severní chodbou u vrátnice", loclist, "pøechod mezi " + l07.getDescription() + " a " + l08.getDescription(), myMap);
		GMNode l07l13 	= new GMNode(Utility.generateGUID(), "Pøechod mezi východní chodbaóu u vrátnice a jižní chodbou KFE", loclist, "pøechod mezi " + l07.getDescription() + " a " + l13.getDescription(), myMap);
		GMNode l08l09 	= new GMNode(Utility.generateGUID(), "Pøechod mezi severní chodbou u vrátnice a chodbou vedoucí k T-101", loclist, "pøechod mezi " + l08.getDescription() + " a " + l09.getDescription(), myMap);
		GMNode l08l10 	= new GMNode(Utility.generateGUID(), "Pøechod mezi severní chodbou u vrátnice a chodbou vedoucí k T-101", loclist, "pøechod mezi " + l08.getDescription() + " a " + l10.getDescription(), myMap);
		GMNode l09l11 	= new GMNode(Utility.generateGUID(), "Pøedsíò T-101", loclist, "pøechod mezi " + l09.getDescription() + " a " + l11.getDescription(), myMap);
		GMNode l10l11 	= new GMNode(Utility.generateGUID(), "Pøedsíò T-101", loclist, "pøechod mezi " + l10.getDescription() + " a " + l11.getDescription(), myMap);
		GMNode l11l12 	= new GMNode(Utility.generateGUID(), "Pøedsíò T-101", loclist, "pøechod mezi " + l11.getDescription() + " a " + l12.getDescription(), myMap);
		GMNode r15 	= new GMNode(Utility.generateGUID(), "T-101", loclist, l12.getDescription(), myMap);
		GMNode r18 	= new GMNode(Utility.generateGUID(), "T-118", loclist, l13.getDescription(), myMap);
		GMNode r19 	= new GMNode(Utility.generateGUID(), "T-119<", loclist, l13.getDescription(), myMap);
		GMNode r20 	= new GMNode(Utility.generateGUID(), "T-120", loclist, l13.getDescription(), myMap);
		GMNode l13l14 	= new GMNode(Utility.generateGUID(), "pøechod mezi jižní chodba KFE a hlavní chodba KFE", loclist, "pøechod mezi " + l13.getDescription() + " a " + l14.getDescription(), myMap);
		GMNode r21 	= new GMNode(Utility.generateGUID(), "T-121", loclist, l14.getDescription(), myMap);
		GMNode r22 	= new GMNode(Utility.generateGUID(), "T-122", loclist, l14.getDescription(), myMap);
		GMNode r23 	= new GMNode(Utility.generateGUID(), "T-123", loclist, l14.getDescription(), myMap);
		GMNode r24 	= new GMNode(Utility.generateGUID(), "T-124", loclist, l14.getDescription(), myMap);
		GMNode r25 	= new GMNode(Utility.generateGUID(), "T-125", loclist, l14.getDescription(), myMap);
		GMNode r26 	= new GMNode(Utility.generateGUID(), "T-126", loclist, l14.getDescription(), myMap);
		GMNode r27 	= new GMNode(Utility.generateGUID(), "Zadní východ z KFE", loclist, l14.getDescription(), myMap);
		...
		GMNode l15l16 	= new GMNode(Utility.generateGUID(), "Západní mezipatro hlavního schodištì 1.-2. patro", loclist, "pøechod mezi " + l15.getDescription() + " a " + l16.getDescription(), myMap);
		GMNode l15l18 	= new GMNode(Utility.generateGUID(), "Hlavní schodištì 2. patro západní èást", loclist, "pøechod mezi " + l15.getDescription() + " a " + l18.getDescription(), myMap);
		GMNode l16l17 	= new GMNode(Utility.generateGUID(), "Východní mezipatro hlavního schodištì 1.-2. patro", loclist, "pøechod mezi " + l16.getDescription() + " a " + l17.getDescription(), myMap);
		//GMNode l16l18 	= new GMNode(Utility.generateGUID(), "l16l18", loclist, "pøechod mezi " + l16.getDescription() + " a " + l18.getDescription(), myMap);
		GMNode l08l16 	= new GMNode(Utility.generateGUID(), "Hlavní schodištì - 1. patro", loclist, "pøechod mezi " + l08.getDescription() + " a " + l16.getDescription(), myMap);
		GMNode l17l18 	= new GMNode(Utility.generateGUID(), "Hlavní schodištì 2. patro východní èást", loclist, "pøechod mezi " + l17.getDescription() + " a " + l18.getDescription(), myMap);
		GMNode l18l19 	= new GMNode(Utility.generateGUID(), "Výtahy 2. patro", loclist, "pøechod mezi " + l18.getDescription() + " a " + l19.getDescription(), myMap);
		GMNode l18l20 	= new GMNode(Utility.generateGUID(), "Roh mezi hlavní shodištìm a chodbou na KFE(2.patro)", loclist, "pøechod mezi " + l18.getDescription() + " a " + l20.getDescription(), myMap);
		GMNode r31 	= new GMNode(Utility.generateGUID(), "T-228 (Lasery)", loclist, lr31.getDescription(), myMap);
		GMNode l19l21 	= new GMNode(Utility.generateGUID(), "Vstup k uèebnám na druhém patøe", loclist, "pøechod mezi " + l19.getDescription() + " a " + l21.getDescription(), myMap);
		GMNode r28 	= new GMNode(Utility.generateGUID(), "Vstup na KFE(2.patro)", loclist, lr28.getDescription(), myMap);
		GMNode r29 	= new GMNode(Utility.generateGUID(), "Dámské WC u KFE(2.patro)", loclist, lr29.getDescription(), myMap);
		GMNode r30 	= new GMNode(Utility.generateGUID(), "Pánské WC u KFE(2.patro)", loclist, lr30.getDescription(), myMap);
		GMNode r32 	= new GMNode(Utility.generateGUID(), "T-204", loclist, lr32.getDescription(), myMap);
		GMNode r33 	= new GMNode(Utility.generateGUID(), "T-205", loclist, lr33.getDescription(), myMap);
		GMNode r34 	= new GMNode(Utility.generateGUID(), "T-206", loclist, lr34.getDescription(), myMap);
		GMNode l21l22 	= new GMNode(Utility.generateGUID(), "Roh chodby mezi jižní chodbou a hlavní chodbou uèeben v 2. patøe", loclist, "pøechod mezi " + l21.getDescription() + " a " + l22.getDescription(), myMap);
		GMNode r35 	= new GMNode(Utility.generateGUID(), "T-207", loclist, lr35.getDescription(), myMap);
		GMNode r36 	= new GMNode(Utility.generateGUID(), "T-208", loclist, lr36.getDescription(), myMap);
		GMNode r37 	= new GMNode(Utility.generateGUID(), "T-209", loclist, lr37.getDescription(), myMap);
		GMNode r38 	= new GMNode(Utility.generateGUID(), "T-210", loclist, lr38.getDescription(), myMap);
		GMNode r39 	= new GMNode(Utility.generateGUID(), "T-211", loclist, lr39.getDescription(), myMap);
		GMNode r40 	= new GMNode(Utility.generateGUID(), "T-212", loclist, lr40.getDescription(), myMap);
		GMNode r41 	= new GMNode(Utility.generateGUID(), "Zadní WC v 2. patøe", loclist, lr41.getDescription(), myMap);
		GMNode l22l23 	= new GMNode(Utility.generateGUID(), "Køižovatka u studovny", loclist, "pøechod mezi " + l22.getDescription() + " a " + l23.getDescription(), myMap);
		GMNode r42 	= new GMNode(Utility.generateGUID(), "T-214", loclist, lr42.getDescription(), myMap);
		GMNode s02 	= new GMNode(Utility.generateGUID(), "Zadní schodištì druhé patro", loclist, ls02.getDescription(), myMap);
		...
		GMNode l18l35 	= new GMNode(Utility.generateGUID(), "Hlavní schodištì ze druhého do tøetího patra", loclist, "pøechod mezi " + l18.getDescription() + " a " + l35.getDescription(), myMap);
		...
		GMNode s03 	= new GMNode(Utility.generateGUID(), "Zadní schodištì u KSE", loclist, ls03.getDescription(), myMap);
		GMNode r43 	= new GMNode(Utility.generateGUID(), "T-010", loclist, ls03.getDescription(), myMap);
		GMNode r57 	= new GMNode(Utility.generateGUID(), "Záchod u KSE", loclist, ls03.getDescription(), myMap);
		GMNode l24l25 	= new GMNode(Utility.generateGUID(), "Vstup do KSE", loclist, "pøechod mezi " + l24.getDescription() + " a " + l25.getDescription(), myMap);
		GMNode r44 	= new GMNode(Utility.generateGUID(), "T-015", loclist, lr44.getDescription(), myMap);
		GMNode r45 	= new GMNode(Utility.generateGUID(), "T-014", loclist, lr45.getDescription(), myMap);
		GMNode r46 	= new GMNode(Utility.generateGUID(), "T-013", loclist, lr46.getDescription(), myMap);
		GMNode r47 	= new GMNode(Utility.generateGUID(), "T-012", loclist, lr47.getDescription(), myMap);
		GMNode r56 	= new GMNode(Utility.generateGUID(), "T-011", loclist, lr56.getDescription(), myMap);
		GMNode r48 	= new GMNode(Utility.generateGUID(), "T-009", loclist, lr48.getDescription(), myMap);
		GMNode r49 	= new GMNode(Utility.generateGUID(), "T-039", loclist, lr49.getDescription(), myMap);
		GMNode r50 	= new GMNode(Utility.generateGUID(), "T-040", loclist, lr50.getDescription(), myMap);
		GMNode l26l31 	= new GMNode(Utility.generateGUID(), "Prùchod na dvùr od KSE", loclist, "pøechod mezi " + l26.getDescription() + " a " + l31.getDescription(), myMap);
		GMNode l26l32 	= new GMNode(Utility.generateGUID(), "Prùchod na dvùr od KJ", loclist, "pøechod mezi " + l26.getDescription() + " a " + l32.getDescription(), myMap);
		GMNode r51 	= new GMNode(Utility.generateGUID(), "Pracovna doktorandù u KJ", loclist, lr51.getDescription(), myMap);
		GMNode r52 	= new GMNode(Utility.generateGUID(), "T-046", loclist, lr52.getDescription(), myMap);
		GMNode l27l32 	= new GMNode(Utility.generateGUID(), "Zadní dveøe KJ", loclist, "pøechod mezi " + l27.getDescription() + " a " + l32.getDescription(), myMap);
		GMNode r53 	= new GMNode(Utility.generateGUID(), "T-062", loclist, lr53.getDescription(), myMap);
		GMNode r54 	= new GMNode(Utility.generateGUID(), "T-066", loclist, lr54.getDescription(), myMap);
		GMNode r55 	= new GMNode(Utility.generateGUID(), "T-067", loclist, lr55.getDescription(), myMap);
		GMNode l27l28 	= new GMNode(Utility.generateGUID(), "Vstup na KJ", loclist, "pøechod mezi " + l27.getDescription() + " a " + l28.getDescription(), myMap);
		GMNode l28n01 	= new GMNode(Utility.generateGUID(), "Výtahy v pøízemí", loclist, l27.getDescription(), myMap);
		GMNode l28n02 	= new GMNode(Utility.generateGUID(), "Roh mezi výtahy a dámskými záchody v pøízemí", loclist, l27.getDescription(), myMap);
		GMNode l06l2801 	= new GMNode(Utility.generateGUID(), "Prùchod od vrátnice ke KJ", loclist, "pøechod mezi " + l06.getDescription() + " a " + l28.getDescription(), myMap);
		GMNode l06l2802 	= new GMNode(Utility.generateGUID(), "Prùchod od vrátnice ke KIPL", loclist, "pøechod mezi " + l06.getDescription() + " a " + l28.getDescription(), myMap);
		GMNode l28l29 	= new GMNode(Utility.generateGUID(), "Vchod na KIPL", loclist, "pøechod mezi " + l28.getDescription() + " a " + l29.getDescription(), myMap);
		...
		GMNode r58 	= new GMNode(Utility.generateGUID(), "KIPL", loclist, lr58.getDescription(), myMap);
		GMNode r59 	= new GMNode(Utility.generateGUID(), "KMAT", loclist, lr59.getDescription(), myMap);
		GMNode r60 	= new GMNode(Utility.generateGUID(), "T-302", loclist, lr60.getDescription(), myMap);
		GMNode r61 	= new GMNode(Utility.generateGUID(), "T-301", loclist, lr61.getDescription(), myMap);
		GMNode r62 	= new GMNode(Utility.generateGUID(), "WC dámské ve tøetím patøe", loclist, lr62.getDescription(), myMap);
		GMNode r63 	= new GMNode(Utility.generateGUID(), "WC pánské ve tøetím patøe", loclist, lr63.getDescription(), myMap);
		GMNode l33n01 	= new GMNode(Utility.generateGUID(), "Roh chodby mezi hlavní schodištìm a KIPL(3.patro)", loclist, l33.getDescription(), myMap);
		GMNode l33n02 	= new GMNode(Utility.generateGUID(), "Roh chodby mezi hlavní schodištìm a KMAT(3.patro)", loclist, l33.getDescription(), myMap); 
		...
		GMNode l35l37 	= new GMNode(Utility.generateGUID(), "Pøed chodbou k T-201", loclist, "pøechod mezi " + l35.getDescription() + " a " + l37.getDescription(), myMap);
		GMNode l33l34 	= new GMNode(Utility.generateGUID(), "Hlavní schodištì ve 3. patøe - západní èást", loclist, "pøechod mezi " + l33.getDescription() + " a " + l34.getDescription(), myMap);
		GMNode l33l36 	= new GMNode(Utility.generateGUID(), "Hlavní schodištì ve 3. patøe - východní èást", loclist, "pøechod mezi " + l33.getDescription() + " a " + l36.getDescription(), myMap);
		GMNode r64 	= new GMNode(Utility.generateGUID(), "T-201", loclist, lr64.getDescription(), myMap);
		...
		GMNode ns01s02 	= new GMNode(Utility.generateGUID(), "Mezipatro zadního schodištì mezi 1. a 2. patrem", loclist, l01.getDescription(), myMap);
		GMNode ns02s03 	= new GMNode(Utility.generateGUID(), "Mezipatro zadní schodištì mezi pøízemím a 1. patrem", loclist, ls02.getDescription(), myMap);
