...
public class tst2 {
	...
	public static GMMap testmap2(UUID guid1, UUID guid2) // potÞebujeme vr‡tit mapu
	{
		...
		GMNode n01 = new GMNode(guid1, 					"n01", myMap.getLocations(), "WC", myMap);
		GMNode n02 = new GMNode(Utility.generateGUID(), "n02", myMap.getLocations(), "chodba", myMap);
		GMNode n03 = new GMNode(Utility.generateGUID(), "n03", myMap.getLocations(), "chodba", myMap);
		GMNode n04 = new GMNode(Utility.generateGUID(), "n04", myMap.getLocations(), "chodba", myMap);
		GMNode n05 = new GMNode(Utility.generateGUID(), "n05", myMap.getLocations(), "schodištì", myMap);
		GMNode n06 = new GMNode(Utility.generateGUID(), "n06", myMap.getLocations(), "místnost T-1xx", myMap);
		GMNode n07 = new GMNode(Utility.generateGUID(), "n07", myMap.getLocations(), "hlavní chodba KM", myMap);
		GMNode n08 = new GMNode(Utility.generateGUID(), "n08", myMap.getLocations(), "hlavní chodba KM", myMap);
		GMNode n09 = new GMNode(Utility.generateGUID(), "n09", myMap.getLocations(), "hlavní chodba KM", myMap);
		GMNode n10 = new GMNode(Utility.generateGUID(), "n10", myMap.getLocations(), "severní chodba KM", myMap);
		GMNode n11 = new GMNode(Utility.generateGUID(), "n11", myMap.getLocations(), "severní chodba KM", myMap);
		GMNode n12 = new GMNode(Utility.generateGUID(), "n12", myMap.getLocations(), "kanceláø KM", myMap);
		GMNode n13 = new GMNode(Utility.generateGUID(), "n13", myMap.getLocations(), "severní chodba KM", myMap);
		GMNode n14 = new GMNode(Utility.generateGUID(), "n14", myMap.getLocations(), "místnost T-115", myMap);
		GMNode n15 = new GMNode(Utility.generateGUID(), "n15", myMap.getLocations(), "severní chodba KM", myMap);
		GMNode n16 = new GMNode(Utility.generateGUID(), "n16", myMap.getLocations(), "místnost T-1xx", myMap);
		GMNode n17 = new GMNode(Utility.generateGUID(), "n17", myMap.getLocations(), "hlavní chodba KM", myMap);
		GMNode n18 = new GMNode(Utility.generateGUID(), "n18", myMap.getLocations(), "místnost T-1xx", myMap);
		GMNode n19 = new GMNode(guid2, 				    "n19", myMap.getLocations(), "hlavní chodba KM", myMap);
		myMap.addNode(n01);
		myMap.addNode(n02);
		myMap.addNode(n03);
		myMap.addNode(n04);
